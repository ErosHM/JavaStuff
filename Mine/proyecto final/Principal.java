...
public class Principal extends JFrame implements ActionListener{
	...
	public Principal(){
		...
		nombreAdministrador=ventanaB.texto;
		...
		miElCreador=new JMenuItem("Desarrollador");
			...
			if(nombreTrabajador.equals("")||AP.equals("")||AM.equals("")||
				...
				if(Departamento.equals("Atencion al cliente")){
					if(Antiguedad.equals("1 año de servicio")){
						textarea1.setText("Recibe 6 dias de vacaciones");
					}else if(Antiguedad.equals("2 a 6 años de servicio")){
						textarea1.setText("Recibe 14 dias de vacaciones");
					}else if(Antiguedad.equals("7 años o más de servicio")){
						textarea1.setText("Recibe 20 dias de vacaciones");										
					}
				}
				if(Departamento.equals("Departamento de Logistica")){
					if(Antiguedad.equals("1 año de servicio")){
						textarea1.setText("Recibe 7 dias de vacaciones");
					}else if(Antiguedad.equals("2 a 6 años de servicio")){
						textarea1.setText("Recibe 15 dias de vacaciones");
					}else if(Antiguedad.equals("7 años o más de servicio")){
						textarea1.setText("Recibe 22 dias de vacaciones");										
					}
				}
				if(Departamento.equals("Departamento de Gerencia")){
					if(Antiguedad.equals("1 año de servicio")){
						textarea1.setText("Recibe 10 dias de vacaciones");
					}else if(Antiguedad.equals("2 a 6 años de servicio")){
						textarea1.setText("Recibe 20 dias de vacaciones");
					}else if(Antiguedad.equals("7 años o más de servicio")){
						textarea1.setText("Recibe 30 dias de vacaciones");										
					}
				}
			}
	...
	public static void main(String args[]){
		...
		ventanaP.setBounds(0,0,645,535);
